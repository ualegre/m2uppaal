...
import edu.casetools.dcase.m2uppaal.juppaal.labels.Probability;
...
public class Transition {
    ...
    /**
     * Creates a new transition between the source and target. These must exist
     * in the template
     * 
     * @param sourceID
     *            The source location
     ...
     * @param nails
     *            A list of nails/positions, to change the apperance of the
     *            transition
     */
